...
xilinx.com:user:sgp_vertexShader:MP3\
...
proc create_hier_cell_memory_subsystem { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S05_AXI] [get_bd_intf_pins memory_intercon/S05_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S06_AXI] [get_bd_intf_pins memory_intercon/S06_AXI]
...
proc create_hier_cell_graphics_subsystem { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 vertexShader_dcache_0_M0_AXI1

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 vertexShader_icache_0_M0_AXI2
  ...
  # Create instance: sgp_vertexShader, and set properties
  set sgp_vertexShader [ create_bd_cell -type ip -vlnv xilinx.com:user:sgp_vertexShader:MP3 sgp_vertexShader ]
  ...
  connect_bd_intf_net -intf_net s_axi_lite4_1 [get_bd_intf_pins s_axi_lite4] [get_bd_intf_pins sgp_vertexShader/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net sgp_vertexShader_0_m1_axi [get_bd_intf_pins vertexShader_dcache_0_M0_AXI1] [get_bd_intf_pins sgp_vertexShader/m1_axi]
  connect_bd_intf_net -intf_net sgp_vertexShader_0_m2_axi [get_bd_intf_pins vertexShader_icache_0_M0_AXI2] [get_bd_intf_pins sgp_vertexShader/m2_axi]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins s_axis_aresetn] [get_bd_pins rasterizer_fifo/s_axis_aresetn] [get_bd_pins sgp_rasterizer/ARESETN] [get_bd_pins sgp_renderOutput/ARESETN] [get_bd_pins sgp_vertexFetch/m_axi_aresetn] [get_bd_pins sgp_vertexShader/ARESETN] [get_bd_pins sgp_viewPort/ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins vertexShader_fifo/s_axis_aresetn] [get_bd_pins vertexfetch_fifo/s_axis_aresetn] [get_bd_pins viewport_fifo/s_axis_aresetn]
  connect_bd_net -net mem_interface_ui_clk [get_bd_pins s_axis_aclk] [get_bd_pins rasterizer_fifo/s_axis_aclk] [get_bd_pins sgp_rasterizer/ACLK] [get_bd_pins sgp_renderOutput/ACLK] [get_bd_pins sgp_vertexFetch/m_axis_aclk] [get_bd_pins sgp_vertexShader/ACLK] [get_bd_pins sgp_viewPort/ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins vertexShader_fifo/s_axis_aclk] [get_bd_pins vertexfetch_fifo/s_axis_aclk] [get_bd_pins viewport_fifo/s_axis_aclk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net graphics_subsystem_vertexShader_dcache_0_M0_AXI1 [get_bd_intf_pins graphics_subsystem/vertexShader_dcache_0_M0_AXI1] [get_bd_intf_pins memory_subsystem/S05_AXI]
  connect_bd_intf_net -intf_net graphics_subsystem_vertexShader_icache_0_M0_AXI2 [get_bd_intf_pins graphics_subsystem/vertexShader_icache_0_M0_AXI2] [get_bd_intf_pins memory_subsystem/S06_AXI]
  ...
  connect_bd_intf_net -intf_net s_axi_lite4_1 [get_bd_intf_pins graphics_subsystem/s_axi_lite4] [get_bd_intf_pins system_intercon/M13_AXI]
  ...
  assign_bd_address -offset 0x44AA0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces debug_subsystem/microblaze_0/Data] [get_bd_addr_segs graphics_subsystem/sgp_rasterizer/s_axi_lite/reg0] -force
  ...
  assign_bd_address -offset 0x44AB0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces debug_subsystem/microblaze_0/Data] [get_bd_addr_segs graphics_subsystem/sgp_vertexShader/s_axi_lite/reg0] -force
  ...
  assign_bd_address -offset 0x44AB0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ethernet_subsystem/axi_mm2s_mapper_0/Bridge] [get_bd_addr_segs graphics_subsystem/sgp_vertexShader/s_axi_lite/reg0] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces graphics_subsystem/sgp_vertexShader/m1_axi] [get_bd_addr_segs memory_subsystem/mem_interface/memmap/memaddr] -force
  assign_bd_address -offset 0x80000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces graphics_subsystem/sgp_vertexShader/m2_axi] [get_bd_addr_segs memory_subsystem/mem_interface/memmap/memaddr] -force
  ...
  assign_bd_address -offset 0x44AA0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces system_intercon/system_dma/Data] [get_bd_addr_segs graphics_subsystem/sgp_rasterizer/s_axi_lite/reg0] -force
  ...
  assign_bd_address -offset 0x44AB0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces system_intercon/system_dma/Data] [get_bd_addr_segs graphics_subsystem/sgp_vertexShader/s_axi_lite/reg0] -force
