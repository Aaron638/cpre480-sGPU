...
################################################################
# This is a generated script based on design: bd_6231
#
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {128} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b01000} \
   CONFIG.SSC001_ROUTE {0b10000} \
   CONFIG.SSC002_ROUTE {0b00100} \
   CONFIG.SSC003_ROUTE {0b01000} \
   CONFIG.SSC004_ROUTE {0b00010} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:S00_AXI:S02_AXI:S03_AXI:S04_AXI} \
 ] $aclk
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins s03_nodes/m_sc_clk] [get_bd_pins s04_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins s03_nodes/m_sc_resetn] [get_bd_pins s04_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
