...
proc create_hier_cell_graphics_subsystem { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_lite3] [get_bd_intf_pins sgp_rasterizer/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net sgp_rasterizer_0_M_AXIS [get_bd_intf_pins rasterizer_fifo/S_AXIS] [get_bd_intf_pins sgp_rasterizer/M_AXIS]
...
proc create_root_design { parentCell } {
  ...
  exclude_bd_addr_seg -offset 0x44AA0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces system_intercon/system_dma/Data] [get_bd_addr_segs graphics_subsystem/sgp_rasterizer/s_axi_lite/reg0]
