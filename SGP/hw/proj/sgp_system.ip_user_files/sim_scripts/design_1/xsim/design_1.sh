...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L lib_cdc_v1_0_2 -L axi_uartlite_v2_0_25 -L xil_defaultlib -L mdm_v3_2_18 -L microblaze_v11_0_3 -L blk_mem_gen_v8_4_4 -L lmb_bram_if_cntlr_v4_0_18 -L lmb_v10_v3_0_11 -L proc_sys_reset_v5_0_13 -L axis_infrastructure_v1_1_0 -L axis_register_slice_v1_1_21 -L axis_switch_v1_1_21 -L axis_dwidth_converter_v1_1_20 -L axi_infrastructure_v1_1_0 -L axi_mm2s_mapper_v1_1_20 -L axis_data_fifo_v2_0_3 -L fifo_generator_v13_2_5 -L lib_fifo_v1_0_14 -L axi_fifo_mm_s_v4_2_3 -L gigantic_mux -L xlconcat_v2_1_3 -L axi_datamover_v5_1_23 -L axi_sg_v4_1_13 -L axi_cdma_v4_1_21 -L xlconstant_v1_1_7 -L smartconnect_v1_0 -L axi_register_slice_v2_1_21 -L axi_vip_v1_1_7 -L generic_baseblocks_v2_1_0 -L axi_data_fifo_v2_1_20 -L axi_crossbar_v2_1_22 -L lib_bmg_v1_0_13 -L axi_vdma_v6_3_9 -L v_tc_v6_1_13 -L v_vid_in_axi4s_v4_0_9 -L v_axi4s_vid_out_v4_0_10 -L v_tc_v6_2_0 -L axi_protocol_converter_v2_1_21 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/bd_6231.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
