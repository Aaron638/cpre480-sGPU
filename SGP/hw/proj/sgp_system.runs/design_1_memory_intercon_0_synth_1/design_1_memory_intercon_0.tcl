...
namespace eval ::optrace {
  variable script "U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_memory_intercon_0_synth_1/design_1_memory_intercon_0.tcl"
...
read_ip -quiet u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_memory_intercon_0_synth_1 -new_name design_1_memory_intercon_0 -ip [get_ips design_1_memory_intercon_0]]
...
if { [catch {
  file copy -force U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_memory_intercon_0_synth_1/design_1_memory_intercon_0.dcp u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_memory_intercon_0_synth_1/design_1_memory_intercon_0_stub.v u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_memory_intercon_0_synth_1/design_1_memory_intercon_0_stub.vhdl u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_memory_intercon_0_synth_1/design_1_memory_intercon_0_sim_netlist.v u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_memory_intercon_0_synth_1/design_1_memory_intercon_0_sim_netlist.vhdl u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir U:/cpre480/SGP/hw/proj/sgp_system.ip_user_files/ip/design_1_memory_intercon_0]} {
  catch { 
    file copy -force u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_stub.v U:/cpre480/SGP/hw/proj/sgp_system.ip_user_files/ip/design_1_memory_intercon_0
  }
}

if {[file isdir U:/cpre480/SGP/hw/proj/sgp_system.ip_user_files/ip/design_1_memory_intercon_0]} {
  catch { 
    file copy -force u:/cpre480/SGP/hw/proj/sgp_system.srcs/sources_1/bd/design_1/ip/design_1_memory_intercon_0/design_1_memory_intercon_0_stub.vhdl U:/cpre480/SGP/hw/proj/sgp_system.ip_user_files/ip/design_1_memory_intercon_0
  }
}
