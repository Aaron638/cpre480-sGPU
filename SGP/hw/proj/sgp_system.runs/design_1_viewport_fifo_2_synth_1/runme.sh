...
HD_PWD='U:/cpre480/SGP/hw/proj/sgp_system.runs/design_1_viewport_fifo_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_viewport_fifo_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_viewport_fifo_2.tcl
