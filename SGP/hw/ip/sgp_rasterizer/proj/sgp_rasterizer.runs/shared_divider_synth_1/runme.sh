...
HD_PWD='U:/cpre480/SGP/hw/ip/sgp_rasterizer/proj/sgp_rasterizer.runs/shared_divider_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shared_divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shared_divider.tcl
