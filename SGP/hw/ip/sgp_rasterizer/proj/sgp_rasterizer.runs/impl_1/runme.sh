...
HD_PWD='U:/cpre480/SGP/hw/ip/sgp_rasterizer/proj/sgp_rasterizer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sgp_rasterizer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sgp_rasterizer.tcl -notrace
