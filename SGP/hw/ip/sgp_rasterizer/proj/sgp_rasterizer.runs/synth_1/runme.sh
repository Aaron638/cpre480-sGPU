...
HD_PWD='U:/cpre480/SGP/hw/ip/sgp_rasterizer/proj/sgp_rasterizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sgp_rasterizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sgp_rasterizer.tcl
