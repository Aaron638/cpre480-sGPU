...
HD_PWD='U:/cpre480/MP-1/hw/ip/sgp_viewPort/proj/sgp_viewPort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sgp_viewPort.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sgp_viewPort.tcl -notrace
