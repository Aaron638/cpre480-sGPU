...
HD_PWD='U:/cpre480/MP-1/hw/proj/sgp_system.runs/design_1_axi_mm2s_mapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_mm2s_mapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_mm2s_mapper_0_0.tcl
