...
HD_PWD='U:/cpre480/MP-1/hw/ip/sgp_viewPort/proj/sgp_viewPort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sgp_viewPort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sgp_viewPort.tcl
